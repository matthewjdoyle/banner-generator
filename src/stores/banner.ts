...
export interface TextElement {
  ...
  x: number
  y: number
  fontSize: 'tiny' | 'small' | 'medium' | 'large' | 'xlarge' | 'xxlarge' | 'huge' | 'massive' | 'giant'
  color: string
...
export const useBannerStore = defineStore('banner', () => {
  ...
  const bannerSizes = ref<BannerSize[]>([
    ...
    { id: 'youtube-channel', name: 'YouTube Channel Art', width: 2560, height: 1440, category: 'Social Media' },
    ...
    { id: 'email-header', name: 'Email Header', width: 600, height: 200, category: 'Web & Digital' },
    { id: 'blog-header', name: 'Blog Header', width: 1200, height: 400, category: 'Web & Digital' },
    
    // Print & Marketing
    { id: 'flyer-horizontal', name: 'Flyer (Horizontal)', width: 1920, height: 1080, category: 'Print & Marketing' },
    { id: 'poster-vertical', name: 'Poster (Vertical)', width: 1080, height: 1920, category: 'Print & Marketing' },
  ...
  const backgroundOptions = ref<BackgroundOption[]>([
    ...
    },
    {
      ...
      preview: 'linear-gradient(90deg, #6B7280 1px, transparent 1px), linear-gradient(#6B7280 1px, transparent 1px)'
    },
    {
      id: 'fancy-diagonal',
    ...
    },
    {
      ...
      preview: 'radial-gradient(circle at 25% 25%, #EC4899 20%, transparent 20%), radial-gradient(circle at 75% 75%, #F472B6 20%, transparent 20%)'
    },
    {
      id: 'fancy-chevron',
      ...
      preview: 'repeating-linear-gradient(90deg, #7C3AED 0px, #7C3AED 10px, #A855F7 10px, #A855F7 20px)'
    },
    {
      id: 'fancy-stars',
      name: 'Starfield',
      ...
      preview: 'radial-gradient(2px 2px at 20px 30px, #FBBF24, transparent), radial-gradient(2px 2px at 40px 70px, #FBBF24, transparent), radial-gradient(1px 1px at 90px 40px, #FBBF24, transparent)'
    },
    {
      id: 'fancy-noise',
      name: 'Digital Noise',
      ...
      preview: 'repeating-conic-gradient(from 0deg, #374151 0deg 90deg, #6B7280 90deg 180deg, #9CA3AF 180deg 270deg, #374151 270deg 360deg)'
    },
    {
      id: 'fancy-bubbles',
      name: 'Bubble Pattern',
      ...
      preview: 'radial-gradient(circle at 20% 80%, #CFFAFE 15%, transparent 15%), radial-gradient(circle at 80% 20%, #67E8F9 15%, transparent 15%), radial-gradient(circle at 40% 40%, #06B6D4 15%, transparent 15%)'
    },
    {
      id: 'fancy-circuit',
      name: 'Circuit Board',
      ...
      preview: 'linear-gradient(90deg, #10B981 2px, transparent 2px), linear-gradient(#10B981 2px, transparent 2px)'
    }
  ])
  ...
  const availableIcons = ref([
    ...
    { id: 'squinting-tongue', name: 'Squinting Face with Tongue', svg: '😝', category: 'Emoji Faces' },
    { id: 'money-mouth', name: 'Money Mouth Face', svg: '🤑', category: 'Emoji Faces' },
    { id: 'hugging', name: 'Hugging Face', svg: '🤗', category: 'Emoji Faces' },
    { id: 'hand-over-mouth', name: 'Face with Hand Over Mouth', svg: '🤭', category: 'Emoji Faces' },
    ...
    { id: 'face-with-thermometer', name: 'Face with Thermometer', svg: '🤒', category: 'Emoji Faces' },
    { id: 'face-with-head-bandage', name: 'Face with Head Bandage', svg: '🤕', category: 'Emoji Faces' },
  ...
  function randomizeBanner() {
    ...
    if (selectedType === 'solid') {
      ...
      console.log('🌈 Gradient Background Created:', { colors: gradientColors, direction: randomDirection })
      ...
      if (fancyBackgrounds.length === 0) {
        ...
        console.log('🎨 Fancy Background Created:', { pattern: baseFancy.name, colors: selectedBackground.patternColors })
      }
    } else {
    ...
    const minFontSizes: Array<TextElement['fontSize']> = scaleFactor > 2 ? 
    ...
    let gradientColor1 = primaryTextColor
    let gradientColor2 = secondaryTextColor
    if (areColorsSimilar(gradientColor1, gradientColor2, 30)) {
      gradientColor2 = textColors.find(color => !areColorsSimilar(color, gradientColor1, 30)) || textColor
    }
    ...
    if (Math.random() > 0.2) {
      const iconCount = template === 'minimal' ? 
      ...
      if (iconCount > 0) {
        ...
        for (let i = 0; i < iconCount; i++) {
          ...
          switch (template) {
            ...
            case 'minimal':
              positions = [
                { x: bannerWidth * 0.8, y: bannerHeight * 0.2 }
              ]
              break
            default:
              positions = [
